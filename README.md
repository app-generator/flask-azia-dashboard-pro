...
**Flask Dashboard** coded with basic modules, database, ORM and deployment scripts on top of **Azia Dashboard PRO** (premium version), a modern Bootstrap dashboard design. Azia Dashboard is a Bootstrap 4 admin & dashboard template featuring components that are built to fit perfectly with each other. It offers a clean interface that can be easily adapted to fit your vision and branding.
...
- [Flask Dashboard - Azia PRO Docs](https://docs.appseed.us/admin-dashboards/flask-dashboard-azia-pro/) - Product documentation
...
![Flask Dashboard Azia PRO - Admin Dashboard template project provided by AppSeed.](https://raw.githubusercontent.com/app-generator/flask-dashboard-azia-pro/master/media/flask-dashboard-azia-pro-screen.png)
...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-flask-dashboard-azia-pro.git
$ cd priv-flask-dashboard-azia-pro
$
...
---
[Flask Dashboard](http://appseed.us/admin-dashboards/flask) **Azia Dashboard PRO** - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
